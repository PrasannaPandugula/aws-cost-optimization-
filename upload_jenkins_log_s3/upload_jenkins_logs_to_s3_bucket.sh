...
###################
# Author: Prasanna
# Description: Shell script to upload Jenkins log file to S3 bucket
# Version: V1
# Date: 10/25/2025
###############################
...
S3_BUCKET="s3://jenkins-logs-storage-dev"
DATE=$(date +%Y-%m-%d)
...
find "$JENKINS_HOME/jobs" -type d -path "*/builds/*" | while read build_dir; do
